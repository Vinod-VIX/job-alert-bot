...
def premium_teaser_text() -> str:
    return (
        ...
        "Free users only see a limited number of jobs per source.\n"
        "👉 Use /subscribe to unlock ALL jobs instantly!"
    )
...
async def cmd_subscribe(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    upi_link = f"https://upi.me/pay?pa={UPI_ID}&pn=TelegramBot&am=199&cu=INR"

    keyboard = [
        [InlineKeyboardButton("💳 Pay ₹199 via UPI", url=upi_link)],
